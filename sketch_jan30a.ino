...
const char ssid[] = "Andress0909";
//Contraseña de la red Wifi
const char pass[] = "1130620818";

//Usuario uniandes sin @uniandes.edu.co
#define HOSTNAME "w.piarpuzan"

//Conexión a Mosquitto
const char MQTT_HOST[] = "iotlab.virtual.uniandes.edu.co";
const int MQTT_PORT = 8082;
//Usuario uniandes sin @uniandes.edu.co
const char MQTT_USER[] = "w.piarpuzan";
//Contraseña de MQTT que recibió por correo
const char MQTT_PASS[] = "202413947";
...
void loop()
{
  ...
  if ( !isnan(h) && !isnan(t) && !isnan(i)) {
    ...
    //Publica en el tópico de la iluminosidad
